...
# ╔═╡ 18ace79d-5109-4126-aee2-98a88c1079b2
using GCPDecompositions.TensorKernels:mttkrp

# ╔═╡ 0816767e-1060-4c8e-bf8d-d3de3dd3a22e
using GCPDecompositions, LinearAlgebra

# ╔═╡ 7db083a0-551c-11ef-2de8-dd8a9e0d19fd
md"""
# Stochastic Gradient Function
"""

# ╔═╡ c7d94b3c-7d87-4dcb-9d18-a70666840b7f

html"""
<div style="display: flex; justify-content: space-around;">
    <figure style="position: relative; width: 70%; margin: 0;">
        <img src="https://i.postimg.cc/R0NPY94r/image.png" alt="Monkey BMI Graphic" style="width: 100%; display: block;">
...
# ╔═╡ 468daf43-e793-4e70-82c4-edb553a48d18
md"""
## The Function
"""

# ╔═╡ 68ac0699-19e1-466e-8c95-546ae691bd5d
...
# ╔═╡ b84ebd8f-313a-4f45-affe-28ab5bf6f8f3
md"""
...
# ╔═╡ 30723552-1325-403f-bcaf-bceeef795428
md"""
## Usage and Example
"""

# ╔═╡ 2ede7254-f1bb-415d-b759-40d9e0ca8de3
X = rand(1:100,88,60,40) # random tensor

# ╔═╡ e7ec16d2-a92e-4e45-a869-414cddcc3a32
M = gcp(X,3) # rank 3 decomposition

# ╔═╡ 77ec22b8-6515-447f-99b1-49a094685dac
names(GCPDecompositions.GCPLosses, all = true)[22:29] # common loss functions

# ╔═╡ eb9339ed-38fd-487d-ae33-c6972f136e19
stoc_grad(X,M,400,GCPLosses.LeastSquares())

# ╔═╡ 398cd8af-87b8-43a5-91d3-d03a43eb6a20
md"""
## Functionality
...
manifest_format = "2.0"
project_hash = "7e8b19ef7bea74d32f7dce6d5ec10b8f300ac478"
