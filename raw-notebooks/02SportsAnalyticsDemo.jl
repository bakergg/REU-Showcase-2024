...
# ╔═╡ 41767354-6448-4b56-815e-ee5f4fbbb2c5
using CSV, TensorCore, GCPDecompositions, LinearAlgebra, CairoMakie, DataFrames, Statistics, Polynomials, CacheVariables

# ╔═╡ c5b65ad2-8e0a-4d0c-8f35-82d7b9a1d4f3
using Downloads, ColorSchemes, DataFramesMeta, Cascadia,HTTP,Gumbo

# ╔═╡ ebd53f31-033f-4575-8a1a-80fae48c072f
md"""
# Sports Analytics - NBA Demo
**includes all regular season games in history between all active teams today**
"""

# ╔═╡ ee0102b8-4193-4a84-9813-ffa000048bb2
html"""
<div style="display: flex; justify-content: space-around;">
    <figure style="position: relative; width: 50%; margin: 0;">
        <img src="https://cdn.vox-cdn.com/thumbor/aqjYyCvUY4zcFC1daYVoJQcR6gg=/0x0:1200x800/1820x1213/filters:focal(502x127:694x319)/cdn.vox-cdn.com/uploads/chorus_image/image/69533240/trae_next_1.0.jpeg" alt="Monkey BMI Graphic" style="width: 100%; display: block;">
        
    
        <figcaption style="position: bottom: 5px; right: 5px; text-align: right; font-style: italic; font-size: 12px;">
            Source: Paolo Uggetti, 
            <a href="https://cdn.vox-cdn.com/thumbor/aqjYyCvUY4zcFC1daYVoJQcR6gg=/0x0:1200x800/1820x1213/filters:focal(502x127:694x319)/cdn.vox-cdn.com/uploads/chorus_image/image/69533240/trae_next_1.0.jpeg">The Ringer</a>, 2021.
        </figcaption>
    </figure>
</div>
"""

# ╔═╡ d69cf285-b016-47f2-97f6-d37aff7cf2e9
md"""
## Scrape and Create DataFrame
"""

# ╔═╡ ed671512-a8ff-417a-a17a-879c0cf472c3
...
# ╔═╡ 9a8f52ae-a696-49ce-8db6-98159723d55e
...
# ╔═╡ dd279dac-f72b-4ad9-bb93-07a31f58c59a
...
# ╔═╡ ecbdf8d8-8f19-4027-a371-54adf1e46d35
md"""
## Create Data Tensor
"""

# ╔═╡ 26f8fbf7-97d8-4c07-b079-917876534a2b
begin
...
# ╔═╡ 8437e164-36d4-479e-8187-28b5e00ddd72
md"""
## Data Visualization
"""

# ╔═╡ 60b19ce4-96b4-4769-93ac-735aa4ea675f
with_theme() do
	...
	# Set super title
	fig[0, 1:n_cols] = Label(fig,"NBA Team Performance Over the Years", fontsize = 20, halign = :center,tellwidth = false, tellheight = true, font = "Bold Arial")
...
# ╔═╡ 5393e4e9-598d-4e3b-9e4b-ff0c34a41fcf
md"""
These bar graphs show when teams were inaugurated, re-franchised (Charlotte), and their records throughout the years.  
"""

# ╔═╡ 8d7353b9-4f4b-433e-82c5-1b3fe08b6cb5
html"""
<div style="display: flex; justify-content: space-around;">
    <figure style="position: relative; width: 70%; margin: 0;">
        <img src="https://i.etsystatic.com/26217843/r/il/4730b2/3133102213/il_1140xN.3133102213_r4sf.jpg" alt="Monkey BMI Graphic" style="width: 100%; display: block;">
        
    
        <figcaption style="position: bottom: 5px; right: 5px; text-align: right; font-style: italic; font-size: 12px;">
            Source: 
NBA License, 
            <a href="https://i.etsystatic.com/26217843/r/il/4730b2/3133102213/il_1140xN.3133102213_r4sf.jpg">NBA</a>, 2021.
        </figcaption>
    </figure>
</div>
...
# ╔═╡ b381ed68-c441-43cb-a605-56c0fbae6d24
with_theme() do
...
with_theme() do
	...
	hidexdecorations!.(contents(fig[2:12, 1:3]); ticks=false, grid=false)
    hideydecorations!.(contents(fig[2:12, 1:3]); ticks=false, grid=false)
	...
	fig[0, 1:3] = Label(fig, "NBA Regular Season Tensor Decomposition", fontsize = 40, halign = :center, valign = :bottom, tellwidth = false, font = "Bold Arial")
	fig
    
end

# ╔═╡ 89faf82b-d44f-461b-aa4e-0ccc3af115cf
md"""
This tensor decomposition accurately predicts the NBA champions throughout the years.  It captures the Bull's dominance in the 90s, Heat short after, Celtics in the 60s and currently, Lakers in the 2000s, 80s, and 50s, Warriors in the late 2010s, and the upcoming Nuggets, Mavericks, etc... showcasing its versatility and usage in statistics.
"""

# ╔═╡ ac8f8830-77b0-4daa-af06-abf7d9c72ac7
md"""
## References
...
manifest_format = "2.0"
project_hash = "afd4f2fa389a258d829cf0ed4acbb9eb8f3797fb"
